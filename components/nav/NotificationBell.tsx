...
export default function NotificationBell({ initial }: Props) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 z-30 bg-white border border-gray-200 rounded-lg shadow-lg w-80">
                ...
                <li key={item.taskId} className="px-4 py-3">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 rounded bg-green-600 px-3 py-1 text-xs font-medium text-white hover:bg-green-700 disabled:opacity-50 transition-colors"
                    >
                    ...
                    <button
                      ...
                      disabled={acting === item.taskId}
                      className="flex-1 rounded border border-gray-300 px-3 py-1 text-xs text-gray-600 hover:bg-gray-50 disabled:opacity-50 transition-colors"
                    >
                      Decline
                    </button>
                  </div>
